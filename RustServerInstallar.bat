@echo off
:: ************************************
REM Rust Server Setup Assistant


:intro
title Rust Server Installation Helper
echo.
pause
cls

:steamcmd
title Installing the SteamCMD...
set steamcmd=C:\SteamCMD
echo Please specify the directory where you would like to install SteamCMD (Default: C:\SteamCMD):
echo.
...
:branch
echo Server Setup in Progress
echo.
echo Choose Your Server Branch:
echo.
echo 1: Main Branch Server (Official Version)
echo 2: Staging Branch Server (Testing Version)
echo.
echo Attention: The Staging Branch does not have built-in support for Oxide. You will need to install Oxide manually if you want to use it.
echo.
...
echo.
echo Enter the directory where you want to install the Rust Server (Default: C:\RustServer)
echo.
set /p forceinstall="Location: "
md "%forceinstall%"
cd /d "%forceinstall%"
title Installing Rust Server... Please wait while the installation process completes.
...
echo WARNING: Ensure there is no existing Rust Server installation in this directory.
echo The directory should be either empty or non-existent.
echo.
echo Enter the location where you want the Rust Staging Branch Server installed (Default: C:\RustStagingServer)
echo.
set /p forceinstall="Location: "
echo.
md "%forceinstall%"
...
:mapchoice
title Initializing Your Server Setup
choice /c yn /m "Do you want to use a custom map file? (If this is your first installation, you probably don't need to): "
cls
